 ...
 * @since 20150911
 */
public class TimeSeriesKSCTest 
{
	public static void main(String[] args) throws IOException 
	{
		...
		alg.clusterAlg(); //进行kmeans聚类;
		
		System.out.println("ksc alg over");
...
//		directory += "\\151231_machine_learning\\";
		...
		System.out.println("===time series ksc test over===");
	}
}
